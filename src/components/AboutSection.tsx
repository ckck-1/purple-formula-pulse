...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-purple-500/8 rounded-full blur-3xl holographic" />
      <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-accent-magenta/8 rounded-full blur-3xl holographic" style={{animationDelay: '5s'}} />

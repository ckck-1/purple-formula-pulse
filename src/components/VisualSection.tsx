  ...
  return (
    <section className="py-20 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 -right-40 w-96 h-96 bg-gradient-to-r from-purple-600/10 to-neon-magenta/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 -left-40 w-80 h-80 bg-gradient-to-l from-neon-magenta/10 to-purple-500/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}} />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {visualCards.map((card, index) => (
            <div
              key={index}
              className={`group glass-panel rounded-2xl overflow-hidden hover:shadow-glow transition-all duration-500 hover:-translate-y-2 animate-fade-in`}
